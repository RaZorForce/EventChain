...
class SignalEvent(Event):
    ...
    def __init__(self, symbol: str, datentime, signal_type:str):
        """
...
class OrderEvent(Event):
    ...
    def __init__(self, symbol: str, order_type: str, quantity: int, direction:str):
        """
        Initialises the order type, setting whether it is a Market
...
class FillEvent(Event):
    ...
    def __init__(self, timeindex: datetime, symbol: str, exchange: str, quantity: int,
                 direction: str, fill_cost: float, commission: float =None) -> None:
        """
        Initialises the FillEvent object. Sets the symbol, exchange, quantity,
        ...
        self.type = 'FILL'
        self.timeindex: datetime = timeindex
        ...
        if commission is None and fill_cost is None:
            self.fill_cost = 1.0
    ...
    def calculate_ib_commission(self) -> float:
        ...
        This does not include exchange or electronic communication network
        (ECN) fees.
